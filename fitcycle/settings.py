"""
Django settings for fitcycle project.
...
SECRET_KEY = 'svgd24=1^knuuozt^jmrkri52g64h)xtsm*y!c^(qmx*u&u95z'
...
WSGI_APPLICATION = 'fitcycle.wsgi.application'
